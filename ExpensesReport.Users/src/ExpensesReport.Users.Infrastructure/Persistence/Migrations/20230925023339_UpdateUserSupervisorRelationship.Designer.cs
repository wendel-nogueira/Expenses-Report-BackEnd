...
namespace ExpensesReport.Users.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230925023339_UpdateUserSupervisorRelationship")]
    partial class UpdateUserSupervisorRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpensesReport.Users.Core.Entities.UserSupervisor", b =>
                {
                    ...
                    b.HasOne("ExpensesReport.Users.Core.Entities.User", "Supervisor")
                        .WithMany()
                        .HasForeignKey("SupervisorId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExpensesReport.Users.Core.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
