...
using ExpensesReport.Users.Application;
using ExpensesReport.Users.Infrastructure;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "ExpensesReport.Users",
        Version = "v1",
        Description = "API to manage users and their information.",
    ...
    var xmlFile = "ExpensesReport.Users.API.xml";
