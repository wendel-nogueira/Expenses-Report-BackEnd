using ExpensesReport.Files.API.Filters;
using ExpensesReport.Files.Infrastructure;
using ExpensesReport.Files.Application;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    var xmlFile = "ExpensesReport.Files.API.xml";
